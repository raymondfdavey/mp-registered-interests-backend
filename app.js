...
app.route("/interests/member/:memberId/year/:date").get(controllers.getMembersInterestsByIdAndDate);
...
app.route("/interests/:memberId/year/:date/category/:category").get(controllers.getMembersInterestsByIdAndDateAndCategory);
...
app.route("/interests/member/:memberId/category/:category").get(controllers.getMembersInterestsByIdAndCategory);

app.route("/interests/member/:memberId/category/:category/year/:date").get(controllers.getMembersInterestsByIdAndDateAndCategory);
