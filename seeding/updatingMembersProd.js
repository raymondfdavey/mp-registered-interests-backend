...
const pathToDatesAndNamesTally = "/Users/rfd/CODING/ONGOING_PROJECTS/mpRegInterests/datesAndNamesTally.JSON";
...
async function upsertListingByName(client, nameOfListing, updatedListing) {
  ...
  result = await client.db("mp_registered_interests").collection("members_production").updateOne({ memberName: nameOfListing }, { $set: updatedListing }, { upsert: true });
